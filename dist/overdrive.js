...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../node_modules/ramjet/dist/ramjet.umd.js":[function(require,module,exports) {
var define;
...
},{}],"Overdrive.vue":[function(require,module,exports) {
"use strict";
...
var _ramjet = _interopRequireDefault(require("ramjet"));
...
var getPosition = function getPosition(node) {
  ...
  return {
    top: "".concat(rect.top - marginTop + (addOffset ? 1 : 0) * (window.pageYOffset || document.documentElement.scrollTop), "px"),
    left: "".concat(rect.left - marginLeft, "px"),
...
var _default = {
  props: {
    ...
    easing: {
      type: Function,
      default: _ramjet.default.linear
    }
  },
  data: function data() {
    return {
  ...
  methods: {
    ...
    cloneAndAppend: function cloneAndAppend() {
      var _components$this$id = components[this.id],
          el = _components$this$id.el,
          pos = _components$this$id.pos;
      var clone = el[0].elm.cloneNode(true);
  ...
  mounted: function mounted() {
    ...
    if (match && !matchedEl) {
      ...
      this.$nextTick(function () {
        ...
        hasBustableCache && _this2.bustCache();
...
exports.default = _default;
        var $641903 = exports.default || module.exports;
      
      if (typeof $641903 === 'function') {
        $641903 = $641903.options;
      }
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$641903', $641903);
          } else {
            api.reload('$641903', $641903);
          }
        }
...
},{"ramjet":"../node_modules/ramjet/dist/ramjet.umd.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"index.js":[function(require,module,exports) {
var global = arguments[3];
"use strict";
...
exports.default = exports.VOverdrive = void 0;

var _Overdrive = _interopRequireDefault(require("./Overdrive.vue"));
...
function install(Vue) {
  ...
  Vue.component('overdrive', _Overdrive.default);
}

var VOverdrive = _Overdrive.default;
...
var _default = plugin;
exports.default = _default;
},{"./Overdrive.vue":"Overdrive.vue"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/overdrive.map